...
<script>
  $(document).ready(function(){
    ...
    $('#frm-filter').submit(function(e){
      ...
      $.post('post.php?mod=laporan&hal=piutang_ajax_layar', data, function(hasil){
    ...
    $('.btn-excel').click(function(e){
      ...
      $('.loading-filter').show();
      var data = $('#frm-filter').serialize();
      $.post('post.php?mod=laporan&hal=piutang_ajax_excel', data, function(hasil){
        window.location='unduhan/laporan_piutang.xlsx';
        $('.loading-filter').hide();
      });
    });
